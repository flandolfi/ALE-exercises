...
\begin{figure}[bh]
  ...
  \begin{tikzpicture}[
    ...
    \path node[below=0.8cm of 12, draw, circle, fill=black, inner sep=0.5mm, minimum width=0, minimum height=0] {} edge[dashed, -latex, out=90, in=-90] (12);
    \path (12) edge[dashed, -latex, out=-100, in=-80, distance=0.8cm] (10);
    \path (10) edge[dashed, -latex, out=-70, in=-110, distance=0.4cm] (11);
